/* CCEP Exam Simulator, Application Logic */

const ACCESS_CODE  = "CCEP9000";
const EXAM_SECONDS = 12600;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "ccep_exam_state_v1";
...
const DOMAIN_LABELS = {"basic_physiology_anatomy_pharmacology_and_genetics": "Basic Physiology Anatomy Pharmacology and Genetics", "clinical_arrhythmias_core_concepts": "Clinical Arrhythmias Core Concepts", "clinical_arrhythmias_bradycardias": "Clinical Arrhythmias Bradycardias", "clinical_arrhythmias_atrial": "Clinical Arrhythmias Atrial", "clinical_arrhythmias_supraventricular_tachycardias": "Clinical Arrhythmias Supraventricular Tachycardias", "clinical_arrhythmias_ventricular": "Clinical Arrhythmias Ventricular", "devices": "Devices", "clinical_scenarios_and_syndromes": "Clinical Scenarios and Syndromes"};  // maps domain key -> human-readable label for display
